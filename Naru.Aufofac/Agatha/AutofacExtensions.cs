...
namespace Naru.Aufofac.Agatha
{
    internal static class AutofacExtensions
    {
        ...
        public static IRegistrationBuilder<TComponent, ConcreteReflectionActivatorData, SingleRegistrationStyle>
            WithLifestyle<TComponent>(
            this IRegistrationBuilder<TComponent, ConcreteReflectionActivatorData, SingleRegistrationStyle> registration,
            Lifestyle lifeStyle)
        {
            switch (lifeStyle)
            {
